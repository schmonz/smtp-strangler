...
class TestStrangler(unittest.TestCase):
    ...
    @unittest.skip('soon')
    def test_reject_mail_from_amitai(self):
        request = StringInput(b'MAIL FROM: amitai\r\n')
        request_instead = StringOutput()
        ...
        expected_request_instead = b'NOOP MAIL FROM: amitai\r\n'
